...
namespace AthenaHealth.Sdk.Http
{
    public interface IHttpClientExtended
    {
        ...
        /// </summary>
        /// <returns>
        /// The base address of Uniform Resource Identifier (URI) of the Internet resource used when
        /// sending requests.
        /// </returns>
        ...
        /// <returns>
        /// The maximum number of bytes to buffer when reading the response content. The default
        /// value for this property is 2 gigabytes.
        /// </returns>
        ...
        /// </summary>
        /// <exception cref="ArgumentOutOfRangeException">
        /// The timeout specified is less than or equal to zero and is not <see cref="Timeout.InfiniteTimeSpan"/>
        /// </exception>
        /// <exception cref="InvalidOperationException">
        /// An operation has already been started on the current instance.
        /// </exception>
        ...
        /// <summary>
        /// Send a GET request to the specified Uri with an HTTP completion option and a cancellation
        ...
        /// <summary>
        /// Send a GET request to the specified Uri and return the response body as a byte array in
        ...
        /// <summary>
        /// Send a GET request to the specified Uri and return the response body as a stream in an
        ...
        /// <summary>
        /// Send a GET request to the specified Uri and return the response body as a string in an
        /// asynchronous operation.
        /// </summary>
        /// <param name="requestUri">The Uri the request is sent to.</param>
        /// <exception cref="ArgumentNullException">The <paramref name="requestUri"/> was null.</exception>
