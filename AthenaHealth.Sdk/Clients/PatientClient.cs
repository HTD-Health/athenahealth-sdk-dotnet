...
namespace AthenaHealth.Sdk.Clients
{
    public class PatientClient : IPatientClient
    {
        ...
        public async Task<PatientCaseResponse> GetPatientCases(int patientId, GetPatientCasesFilter queryParameters)
        {
            return await _connection.Get<PatientCaseResponse>($"{_connection.PracticeId}/patients/{patientId}/patientcases", queryParameters);
        }

        [Endpoint("GET /chart/{patientid}/vitals")]
        public async Task<PatientVitalResponse> GetPatientVitals(int patientId, GetPatientVitalsFilter queryParameters)
        {
        ...
        public async Task<PatientCustomField[]> GetPatientCustomFields(int patientId, int departmentId)
        {
            var queryParameters = new
            {
                departmentid = departmentId
            ...
            return await _connection.Get<PatientCustomField[]>($"{_connection.PracticeId}/patients/{patientId}/customfields", queryParameters);
        }
    }
}
